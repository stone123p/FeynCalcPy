...
~~~
where we use SymPy.symbols to define p_mu,m_mu,n to do the algebra. And GammaSlash(n) is meant $\gamma^\aloha n_\alpha$. To define the gamma matrix with specific superscript index $\gamma^\mu$, we can 
~~~ python
